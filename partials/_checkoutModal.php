        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="Type address here" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Address Line 2:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="near mirpur 10, Dhaka" type="text">
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="xxxxxx" required pattern="[0-5]{6}" maxlength="6">                    
                    </div>
                </div>
                <div class="form-group">
